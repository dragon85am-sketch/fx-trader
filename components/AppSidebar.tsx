      ...
      ? [
          { label: "Dashboard", href: "/dashboard" },
          {
            ...
            children: [
              ...
              { label: "Kalendarz ekonomiczny", href: "/trading-room?tab=live" },
              { label: "Kalendarz wyników", href: "/trading-room?tab=calendar" },
            ],
          },
          {
            label: "Skaner rynku",
            href: "/skaner",
            children: [
              { label: "Skaner FX", href: "/skaner/fx" },
              { label: "Skaner harmoniczny", href: "/skaner/harmonic" },
              { label: "PRO FX Scanner", href: "/skaner/pro" },
                            { label: "Alpha Scanner", href: "/skaner/alpha" },
              { label: "GOLD Scalping", href: "/skaner/gold" },
            ],
          },
          {
            label: "Strategie",
            ...
            children: [
              ...
              { label: "Strategia Renko", href: "/strategie/renko" },
              { label: "Strategia SuperTrend", href: "/strategie/supertrend" },
